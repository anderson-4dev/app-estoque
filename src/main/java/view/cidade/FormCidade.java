...
public class FormCidade extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        isEstados.setInputLabel("Estado");
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        Estado estado = (Estado) isEstados.getSelectedItem();
        
        CidadeControl control = new CidadeControl();
        
        if(control.save(id, nome, estado)){
            this.success = true;

            components.Message.show(null,"Cidade registrada com sucesso.");
            this.loadJtable();
            this.cancelForm();
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        if(id > 0){
            ...
            if(control.delete(id)){
                components.Message.show(null, "Cidade excluida da base de dados!");
                this.success = true;
                this.loadJtable();
                this.cancelForm();
            }else{
                components.Message.show(null, "Cidade não pode ser excluida!");
            }
            control.closeConection();
        }
    ...
    private void loadForm() {
        ...
        if(index > -1){
            Cidade u = cidades.get(index);
            this.editForm();
            
            this.iCodigo.setInputText(u.getId());
            this.iNome.setInputText(u.getNome());
            this.isEstados.setSelectedItem((Object) u.getEstado());
        }
        
    }

    private void loadEstados() {
        //this.estados = EnderecoControl.getEstados();
        isEstados.loadOptions((List<Object>) (Object) EnderecoControl.getEstados());
    }
}
