...
public class FormCategoria extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        iUnidade.setInputLabel("Categoria");
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        CategoriaControl uControl = new CategoriaControl();
        
        if(uControl.save(id, nome)){
            this.success = true;

            components.Message.show(null,"Categoria registrada com sucesso.");
            this.loadJtable();
            this.cancelForm();
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        if(id > 0){
            ...
            if(uControl.delete(id)){
                components.Message.show(null, "Categoria excluida da base de dados!");
                this.success = true;
                this.loadJtable();
                this.cancelForm();
            }else{
                components.Message.show(null, "Categoria não pode ser excluida!");
            }
            //uControl.closeConection();
        }
    ...
    private void loadForm() {
        ...
        if(index > -1){
            Categoria u = categorias.get(index);
            this.editForm();
